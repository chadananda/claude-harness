---
name: modern-python
description: Configures Python projects with modern tooling (uv, ruff, ty). Use ONLY when working in Python — creating Python projects, writing Python scripts, or migrating from pip/Poetry/mypy/black. Do not activate for non-Python languages.
---
