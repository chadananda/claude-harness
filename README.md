...
- [Domain: dev](#dev--software-development) — TDD, agent pipeline, teams, harness enforcement
- [Other Domains](#other-domains) — plan, doc, content, review, seo, plan-saas, plan-api
...
|--------|------|-------------|---------|
| [plan](docs/README_DOMAIN_plan.md) | Requirements gathering, task decomposition | ~10 lines | 5W1H → MoSCoW → task DAGs |
| [doc](docs/README_DOMAIN_doc.md) | Documentation, READMEs, JSDoc | ~10 lines | Co-located, concise, practical |
| [content](docs/README_DOMAIN_content.md) | Blog posts, articles, copywriting | ~45 lines | SEO headers, structure, quality gates |
| [review](docs/README_DOMAIN_review.md) | Code review, audits | ~10 lines | Correctness, OWASP, YAGNI, minimize |
